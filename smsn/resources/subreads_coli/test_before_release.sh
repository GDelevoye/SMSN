...
echo "cmd1 = smsn --bam ./HTVEG_Coli.subreads.bam --reference ./../e_coli_O157.fasta --output_csv ./methylationout_HTVEG_Coli.csv --verbosity INFO --add_context True --progress_bar True --nb_proc 12 --min_subreads 50 --idQvs True --min_identity 0.99 --model SP2-C2"
smsn --bam ./HTVEG_Coli.subreads.bam --reference ./../e_coli_O157.fasta --output_csv ./methylationout_HTVEG_Coli.csv --verbosity INFO --add_context True --progress_bar True --nb_proc 12 --min_subreads 50 --idQvs True --min_identity 0.99 --model SP2-C2
