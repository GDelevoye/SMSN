...
```diff
! I am currently looking for SMSN data sequenced with the Sequel II sequencer in order to test my pipeline. 
! If you appear to be interested in using this software with Sequel II data, 
! I can help you with the analysis if you have that kind of data. 
```
